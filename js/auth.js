...
if (loginForm || registerForm || resetForm) {
    document.querySelectorAll('a[href="login.html"]').forEach(link => { link.href = "index.html?auth=login"; });
    document.querySelectorAll('a[href="register.html"]').forEach(link => { link.href = "index.html?auth=register"; });
}
